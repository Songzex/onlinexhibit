...
import com.example.pojo.MongoChapter;
...
public class ComicServiceImpl extends ServiceImpl<ComicMapper, Comic>
  ...
  public void addAdapter(Integer id, MultipartFile file) throws IOException {
       String originalFilename = file.getOriginalFilename();InputStream stream = file.getInputStream();
    ...
    public List<String> getChapter(GetComicFrom from) {
        ...
        return Objects.requireNonNull(mongoTemplate.findOne(query, MongoChapter.class)).getUrl();
    }
