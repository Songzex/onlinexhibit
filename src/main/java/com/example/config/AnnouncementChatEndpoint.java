 ...
 */
// 服务器端 WebSocket 处理类
@ServerEndpoint(value = "/websockets/{userid}")
@Component("announcementChatEndpoint")
@Slf4j
public class ChatEndpoint {
    ...
    @OnMessage
    public void onMessage(String message, Session session, @PathParam("useridz") String senderUsername) {
